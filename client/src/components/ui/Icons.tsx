...
export const StarIcon: React.FC<IconProps> = ({ className = "", size = 20, onClick = () => {} }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const Share2Icon: React.FC<IconProps> = ({ className = "", size = 20, onClick = () => {} }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SortAscIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
